...
void loop() {
  ...
  if (xorpins != 0) {
    ...
    Serial.println("xorpins: ");
    Serial.print(xorpins, BIN);
    Serial.println();
    
//    Serial.print("time_elaspsed: ");
//    Serial.println(time_elapsed);

    Serial.print("shift by 4 ");
    Serial.println(pinval >> 4, BIN);
    Serial.print("Shift by 5 ");
    Serial.println(pinval >> 5, BIN);
    Serial.println();
