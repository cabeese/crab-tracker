...
and computers using common GPIO pins.
...
The timestamp recorder reads a digital signal on a GPIO pin and records the
``time'' at which the signal changed from low to high or vice versa.
...
Use of a non-blocking protocol such as SPI (Serial Perhipheral Interface) is
