  ...
  for (double i = -10.0; i <= 10.0; i += 0.1) {
    for (double j = -10.0; j <= 10.0; j += 0.1) {
      for (double k = 3.0; k <= 10.0; k += 0.1) {
        ...
        // unsigned long ts_a = intTimes.ts_a + (rand() % 6 + -6);
        // unsigned long ts_b = intTimes.ts_b + (rand() % 6 + -6);
        // unsigned long ts_c = intTimes.ts_c + (rand() % 6 + -6);
        // unsigned long ts_d = intTimes.ts_d + (rand() % 6 + -6);
