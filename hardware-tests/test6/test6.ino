...
*  Test code for pulse collector, prints out the delta's for two timestamps
*  Doesn't work for small deltas
*
*/

// Masks off digital pins 0, 1, and 2. 
// Most significant bit of register corresponds to dignital pin 7
uint8_t bitMask = 0B11111000;
...
//    for debugging: confirm that expected values are stored 
    ...
    unsigned long previous_time = output[i-1][1];
    Serial.println(previous_time, DEC);
    Serial.print("stored time: ");
    unsigned long current_time = output[i][1];
